...
# align-items: center works on Cross-Axiz or vertical axis.

5. Explain why git is valuable to a team of developers.

# Git is valuable tool to keep track of changes on the source code. Additionally, it helps communicate those changes with the team. 
